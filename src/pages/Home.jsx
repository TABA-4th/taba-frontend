...
const Home = () => {
  ...
  return (
    ...
    <div >
      ...
      {isMobile && (
      <div>
        <div style={{ backgroundImage: 'https://postimg.cc/YjYWyVLy', color: 'black', padding: '70px' }}>
          <h2 style={{ fontWeight:"bold" }}>대한민국 1등 진단 앱 니모내모</h2>
      ...
      {isTablet && (
        <div>
        <div style={{ backgroundImage: 'https://postimg.cc/YjYWyVLy', color: 'black', padding: '150px' }}>
        <h2 style={{ fontWeight:"bold" }}>대한민국 1등 진단 앱 니모내모</h2>
          <p>두피 진단과 건강 솔루션을 찾아보세요</p>
        </div>
        <MainSlider></MainSlider>
      ...
      {isDesktop && (
        ...
        <div style={{ backgroundImage: `url('https://i.postimg.cc/jS0hHVDf/Kakao-Talk-20231124-165154753.jpg')`, color: 'black', padding: '250px' }}>
        <h2 style={{ fontWeight:"bold" }}>대한민국 1등 진단 앱 니모내모</h2>
          <p>두피 진단과 건강 솔루션을 찾아보세요</p>
          <br/><br/>
          <Button variant="outlined"  href="/about"> 더 알아보기 </Button> <Button variant="outlined" href="/survey">바로 진단 시작!</Button>
        </div>
        ...
        <div className={styles.texts}>
          ...
          <Row xs={1} md={2} className="g-4">
            {images.map((imgSrc, idx) => (
              <Col key={idx}>
                <Card>
                  <Card.Img variant="top" src={imgSrc} /> {/* 이 부분을 수정하세요 */}
                  <Card.Body>
